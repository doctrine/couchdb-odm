...
JSO;
        ...
        $doc = $this->getMock('Doctrine\ODM\CouchDB\View\DesignDocument');
        $doc->expects($this->once())
            ->method('getData')
            ->will($this->returnValue(array()));

        $client = $this->getMock('Doctrine\ODM\CouchDB\HTTP\Client', array(), array(), '', false);
        ...
        $client->expects($this->at(1))
               ...
               ->will($this->returnValue(new \Doctrine\ODM\CouchDB\HTTP\Response(201, array(), "", false)));
